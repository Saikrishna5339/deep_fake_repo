...
def plot_confusion_matrices(accuracy_dict):
...
# ---------- 4. ROC Curves ----------
def plot_roc_curves(accuracy_dict):
    plt.figure(figsize=(12, 8))
...
def plot_precision_recall_curve(accuracy_dict):
    plt.figure(figsize=(12, 8))
...
def plot_model_comparison_bar_graph(accuracy_dict, roc_auc_value):
...
def plot_parameter_count_vs_accuracy(accuracy_dict):
...
def main():
    ...
    accuracy_dict = plot_accuracy_vs_epochs()
    plot_loss_vs_epochs()
    plot_confusion_matrices(accuracy_dict)
    roc_auc_value = plot_roc_curves(accuracy_dict)
    plot_precision_recall_curve(accuracy_dict)
    plot_model_comparison_bar_graph(accuracy_dict, roc_auc_value)
    plot_parameter_count_vs_accuracy(accuracy_dict)
